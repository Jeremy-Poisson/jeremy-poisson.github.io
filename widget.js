...
<div class="chat-header">
            <div class="chat-header-content">
                <img src="jp-headshot.png" alt="Chat Icon">
                <div class="chat-header-text">
                    <h2>Online Now</h2>
Chat with an assistant from <br>Digital Footprints
<!---Or call me at <a id="phone" href="tel:7165759053">(716) 575-9053</a> <br> type: <i>voice</i> to switch to voice  --->
 ...
 <!-- Live Chat Popup -->
  <div class="chat-popup" id="chatBox">
    <img src="jp-headshot.png" alt="Agent" class="agent-img">
...
<br><i> Mic icon = voice call <br>Text bubble = text chat</i>-->
  ...
  const assistantId = "4d3ebc72-0dd0-405d-a794-19e8126ea24f";
